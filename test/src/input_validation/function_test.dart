...
void main(){
  group('input strings fail when not a valid math function:', () {
    ...
    group('invalid input', () {
      test('multiple decimals', () {
        var string = '3.45.6';
        expect(tester.checkSyntax(string), 0);///TODO
      });

      test('undefined function', () {
        var string = 'abc(3+4)';
        expect(tester.checkSyntax(string), 0);
      });
      ...
      test('invalid comma position 4', () {
        var string = 'max(,4)';
        expect(tester.checkSyntax(string), 4);
      });

      test('invalid comma function', () {
        var string = 'sin(4,2)';
        expect(tester.checkSyntax(string), 5);
      });

      test('invalid complex comma function', () {
        var string = 'tan(2+sin(2),(3*4)*cos(2))';
        expect(tester.checkSyntax(string), 12);
      });
    });
    ...
    group('invalid pairs of parentheses', () {
      ...
      test('no empty parentheses', () {
        var string = '2*()';
        expect(tester.checkSyntax(string), 3);
      });
      ...
      test('invalid parenthesis', () {
        var string = 'max(4,2))';
        expect(tester.checkSyntax(string), 8);
      });
    });
  });
  ...
  group('input strings pass when a valid math function:', () {
    ...
    group('valid functions:', () {
      ...
      test('square root', () {
        var expression = '√(4)';
        expect(tester.checkSyntax(expression), -1);
      });
    });
